...
<form name="frmacao">
    ...
    <table>
        ...
        <td>
            <button type="button" id="confirmar" name="confirmar" onclick="return getResponse(frmacao,'Excluir');">Excluir Procurador</button>
        </td>
    </table>
    ...
    <input type="text" id="pronome" name="pronome" size="50" maxlength="45" nullable="false" key="" disabled=disabled>
    
    <label for="nome">Nome:</label>
    <input type="text" id="nome" name="nome" size="50" maxlength="45" nullable="false" key="" disabled=disabled>
    
    <label for="cargo">Cargo:</label>
    <input type="text" id="cargo" name="cargo" size="50" maxlength="45" nullable="false" key="" disabled>

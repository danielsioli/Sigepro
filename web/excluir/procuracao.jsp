...
<form name="frmacao">
    ...
    <table>
        ...
        <td>
            <button type="button" id="confirmar" name="confirmar" onclick="return getResponse(frmacao,'Excluir');">Excluir Procuração</button>
        </td>
    </table>
    ...
    <input type="text" id="procuradorCpf" name="procuradorCpf" size="23" maxlength="18" onblur="return isValidCnpjOrCpf(this);" nullable="false" key="PRI" value="<%=(request.getParameter("procuradorCpf") != null ? request.getParameter("procuradorCpf"): "")%>">
    ...
    <input type="text" id="validade" name="validade" size="10" maxlength="15" onblur="return isValidDate(this);" nullable="true" key="" disabled=disabled>
